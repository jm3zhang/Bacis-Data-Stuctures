...
void Leftist_heap<Type>::push( const Type &) {
	...
	//static_cast<int>
	Leftist_node<Type> *new = new Leftist_node<Type>(obj)
	root_node -> push(new,root_node)
...
Type Leftist_heap<Type>::pop() {
	...
	Leftist_node<Type> *new_right;
	Leftist_node<Type> *old_root;
	old_root = root_node;
	new_right = root_node -> right();
	root_node = root_node -> left();
	push(new_right,root_node);
	heap_size --;

	return old_root -> retrieve(); 
}
